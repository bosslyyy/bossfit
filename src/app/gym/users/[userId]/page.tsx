...
export default function AdminUserDetailPage() {
  ...
  if (!detail) {
    return <AdminDataState title="No encontramos al usuario" description={error ?? "Puede que ya no pertenezca a este gym."} actionLabel="Volver" onAction={() => router.push("/gym/users")} tone="warning" />;
  }
